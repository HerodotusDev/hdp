use crate::primitives::processed_types::datalake_compute::ProcessedDatalakeCompute as BaseProcessedDatalakeCompute;
...
mod tests {
    ...
    fn test_datalake_compute_to_serde() {
        let processed_string =
            include_str!("../../../../../fixtures/primitives/processed/datalake_compute.json");
        ...
        let json_file = include_str!(
            "../../../../../fixtures/primitives/processed_in_felts/datalake_compute.json"
        );
