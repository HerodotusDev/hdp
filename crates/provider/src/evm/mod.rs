...
impl AbstractProvider {
    ...
    pub async fn get_tx_with_proof_from_nonce_range(
        ...
        for tx in &tx_result {
            txs_mpt_handler
                .build_tx_tree_from_block(tx.block_number.parse().unwrap())
                .await
                .unwrap();
