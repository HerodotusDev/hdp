...
impl DatalakeCodec {
    ...
    fn decode_single(&self, serialized_datalake: String) -> Result<DatalakeEnvelope> {
        ...
        Ok(self._decode_single(datalake_code, datalake_string)?)
    }

    /// Decode a batch of datalakes
    fn decode_batch(&self, serialized_datalakes_batch: String) -> Result<Vec<DatalakeEnvelope>> {
        ...
        if let Some(datalakes) = serialized_datalakes.as_array() {
            for datalake in datalakes {
                ...
                decoded_datalakes.push(self._decode_single(datalake_code, datalake_string)?);
            }
        }
    ...
    pub fn encode_single(&self, datalake: DatalakeEnvelope) -> Result<String> {
    ...
    pub fn encode_batch(&self, datalakes: Vec<DatalakeEnvelope>) -> Result<String> {
...
impl ComputeCodec {
    ...
    pub fn decode_single(&self, serialized_task: String) -> Result<Computation> {
        Ok(self._decode_single(serialized_task.as_bytes())?)
    }

    /// Decode a batch of computations
    pub fn decode_batch(&self, serialized_tasks_batch: String) -> Result<Vec<Computation>> {
        ...
        if let Some(tasks) = serialized_tasks.as_array() {
            for task in tasks {
                decoded_tasks.push(self._decode_single(task.as_bytes().unwrap())?);
            }
        }
    ...
    pub fn encode_batch(&self, tasks: Vec<Computation>) -> Result<String> {
    ...
    fn encode_single(&self, task: Computation) -> Result<String> {
        Ok(task.encode()?)
    }
}
...
impl DatalakeComputeCodec {
    ...
    pub fn encode_single(&self, datalake_compute: DatalakeCompute) -> Result<(String, String)> {
        let encoded_datalake = self
            .datalake_codec
            .encode_single(datalake_compute.datalake)?;
        info!("Encoded datalake: {}", encoded_datalake);
        let encoded_compute = self.compute_codec.encode_single(datalake_compute.compute)?;
        info!("Encoded compute: {}", encoded_compute);
    ...
    pub fn encode_batch(
        ...
        info!("Encoded computes: {}", encoded_computes);
...
mod tests {
    ...
    fn test_block_datalake_decoder() {
        ...
        let decoded_datalakes = datalake_decoder
            .decode_batch(batched_block_datalake.to_string())
            .unwrap();
    ...
    fn test_transaction_datalakes_encoder() {
        ...
        assert_eq!(encoded_datalakes, "")
    }
    ...
    fn test_transaction_datalake_decoder() {
        ...
        let decoded_datalake = datalake_decoder
            .decode_batch(encoded_datalake.to_string())
            .unwrap();
    ...
    fn test_transaction_datalakes_encoder_receipt() {
        ...
        assert_eq!(encoded_datalakes, "")
    }
