...
CMD source /root/.bashrc && \
    hdp local-run-module 0x4F21E5,0x4F21E8,0x13cb6ae34a13a0977f4d7101ebc24b87bb23f0d5 --pre-processor-output /hdp-demo/hdp_input.json --chain-id 11155111 --class-hash 0x02aacf92216d1ae71fbdaf3f41865c08f32317b37be18d8c136d442e94cdd823 --rpc-url https://sepolia.ethereum.iosis.tech/ --module-registry-rpc-url https://pathfinder.sepolia.iosis.tech/ && \
    cairo-run --program /hdp-demo/build/compiled_cairo/hdp.json --layout starknet_with_keccak --program_input /hdp-demo/hdp_input.json --print_info --print_output